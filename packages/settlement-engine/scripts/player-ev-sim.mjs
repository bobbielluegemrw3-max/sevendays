...
// ---- 3. 等価規模チェック: 021時代の「24人」は092で何人分か ----
if (process.env.EQUIV_CHECK) {
  console.log('');
  console.log('=== 等価規模: 021の直紹介24人(各2〜3頭)と同じ体験を092で得るには ===');
  for (const [name, tiers, model] of [
    ['021: 24人×2頭(記憶の98%)', [[24, 2]], 'burn021'],
    ['092: 96人×2頭(4倍)', [[96, 2]], 'celebration092'],
    ['021: 24人×3頭', [[24, 3]], 'burn021'],
    ['092: 96人×3頭(4倍)', [[96, 3]], 'celebration092'],
    ['092: 24人×3頭+深さ3(24→48→96)', [[24, 3], [48, 3], [96, 3]], 'celebration092'],
  ]) {
