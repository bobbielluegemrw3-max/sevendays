...
export const API_ERROR_STATUS: Record<string, number> = {
  ...
  // A3 (WALLET_HARDENING §2/§3): 出金先ホワイトリスト + 新規宛先クーリング
  WITHDRAWAL_ADDRESS_NOT_ALLOWED: 403,
  WITHDRAWAL_ADDRESS_COOLING: 403,
  // B (WALLET_HARDENING §3): 出金の連射防止(5分以内の連続を拒否)
  WITHDRAWAL_TOO_FREQUENT: 429,
  ...
  // 馬転送 (Decision 094)
  HORSE_LISTED: 409,
  HORSE_TRANSFER_LIMIT: 429,
  HORSE_TRANSFER_DAILY: 409,
  HORSE_GIFTED_NO_MANUAL_LISTING: 409,
  // 厩舎名 (Decision 097)
  STABLE_NAME_INVALID: 400,
  STABLE_NAME_TAKEN: 409,
  STABLE_NAME_DAILY_LIMIT: 429,
  // セミナー特典馬 (Decision 095)
  PROMO_CODE_INVALID: 404,
  PROMO_CODE_USED: 409,
  PROMO_CODE_EXPIRED: 410,
