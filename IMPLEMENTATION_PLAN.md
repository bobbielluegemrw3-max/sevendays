...
| P8 | **horse_type_modifier の算出方法** — 加算式に独立項として存在(範囲-3.00〜+3.00)するが、タイプの強みはweather/track相性表(Decision 053)で表現済み。二重計上を避けるため **v1.0では0.00固定として実装**(要オーナー追認) | Phase 5 実装済み・追認待ち |
