...
const ja: LandingDict = {
  ...
  ladder_burn_v: '0',
  ladder_burn_d: 'BURN',
  s5_p3: '負けた馬は消える。価値は0になり、戻らない — 毎レース、成績下位の馬から。',
  s5_h2: '走った馬は、売れる。',
...
const en: LandingDict = {
  ...
  ladder_burn_v: '0',
  ladder_burn_d: 'BURN',
  s5_p3: 'A horse that loses is burned. Its value becomes 0 and never returns — every race, starting from the lowest finishers.',
...
const zh: LandingDict = {
  ...
  ladder_burn_v: '0',
  ladder_burn_d: 'BURN',
  s5_p3: '落败的马会消失。价值归零，且不会回来 — 每场比赛，从成绩末位的马开始。',
  s5_h2: '跑过的马，可以卖出。',
...
const ko: LandingDict = {
  ...
  ladder_burn_v: '0',
  ladder_burn_d: 'BURN',
  s5_p3: '패한 말은 사라집니다. 가치는 0이 되고 돌아오지 않습니다 — 매 레이스, 성적 하위의 말부터.',
  s5_h2: '달린 말은 팔 수 있다.',
...
const ms: LandingDict = {
  ...
  ladder_burn_v: '0',
  ladder_burn_d: 'BURN',
  s5_p3: 'Kuda yang kalah akan dibakar. Nilainya menjadi 0 dan tidak kembali — setiap perlumbaan, bermula daripada yang terbawah.',
