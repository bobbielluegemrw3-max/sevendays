...
const ja: LandingDict = {
  ...
  step04_t: 'P2P売買',
  step04_d: '生き残り馬は価値が高まったままP2P売買に自動利確。馬の所有者は即座にUSDTになります。',
  ...
  s5_h2: '走った馬は、売れる。',
  s5_p: '毎晩のレースが終わると、マーケットプレイスが開く。生き残ったあなたの馬は、価値が上がった状態で取引される。高く売って利確するか、明日も走らせて更に狙うか、新しい馬を迎えるか — それを決めるのが、厩舎のオーナーの仕事だ。',
...
const en: LandingDict = {
  ...
  step04_d: 'Survivors carry their higher value into P2P trades and auto-realize. The owner receives USDT immediately.',
  ...
  s5_p: 'When each night’s race ends, the marketplace opens. Your surviving horses trade at their raised value. Sell high, run again tomorrow for more, or take in a new horse — deciding is the stable owner’s job.',
...
const zh: LandingDict = {
  ...
  hero_lead: '奔跑七天。所有马匹同时起跑。垫底者被销毁（Burn），存活的马每天升值。可P2P交易。',
  ...
  step02_t: '训练并出赛',
  step02_da: '赛前每天可训练一次。每晚 ', step02_db: '，所有马匹同时起跑。',
  step03_t: '存活或销毁',
  step03_d: '每天一场比赛。每晚所有现存马匹同时出赛。成绩垫底的马被销毁（Burn，全部记录公开在账本）。存活的马升值并进入次日比赛。',
  step04_t: 'P2P交易',
  step04_d: '存活的马带着升高的价值进入P2P交易并自动获利了结。马主立即获得USDT。',
  step05_t: '第7天 → 冠军',
  ...
  s3_closing: '买入、训练、出赛、卖出。每一个决定，都成为你马房的故事。',
  s4_h2: '每晚20:00，全马同场的巨型比赛。',
  s4_lead_a: '在你的国家是 ', s4_lead_b: ' — 马房的马每晚出战每日德比。胜出的马升值（100 → 110 → 121 → …），落败的马被销毁（Burn）。',
  mylane_yours: '你的马',
  ...
  s5_h2: '跑过的马，可以卖出。',
  s5_p: '每晚比赛结束后，市场开启。你存活的马以升高的价值交易。高价卖出了结、明天继续跑争取更多、还是迎接新马 — 决定权在马房主人手中。',
  s5_p2: '存活越久，价值越高。何时放手，由你选择。',
  s6_h2: '连胜七晚的马，成为冠军。',
  champ_small: '奖励分七天发放，合计200 USDT。',
  s6_p: '冠军马不再参赛，也不再上市。跑完全程的证明，作为纪念NFT留在马房。',
  league_p: '活跃用户达到10,000人时开赛。只有拥有冠军马的马房才能参加的周赛联赛。每周都有奖金。',
  s7_h2: '同伴的荣耀，是团队的祝福。',
  ...
  s9_lead_c: '结果由事先承诺的种子确定性计算，赛后公开种子。任何人都能重新计算并验证。',
...
const ko: LandingDict = {
  ...
  hero_cta_adopt: '말을 맞이하기 ▶', hero_cta_how: '플레이 방법 보기',
  ...
  step03_t: '생존 또는 소멸',
  step03_d: '하루 한 번 레이스 개최. 매일 밤 존재하는 모든 말이 일제히 출전. 하위 성적의 말은 소멸(Burn, 모든 기록은 원장에 공개). 살아남은 말은 가치가 올라 다음 날 레이스로.',
  step04_t: 'P2P 거래',
  step04_d: '살아남은 말은 오른 가치를 지닌 채 P2P 거래로 자동 이익 실현. 소유자는 즉시 USDT를 받습니다.',
  step05_t: '7일차 → 챔피언',
  step05_d: '7일을 완주하면 200 USDT를 7회로 수령. 완납 시 기념 NFT가 됩니다.',
  s3_h2: '이것은 마구간의 게임이다.',
  s3_lead: '당신은 마구간의 주인. 당신이 맞이하는 말이 당신의 7일을 결정한다.',
  q1_h: '모으기', q1_p: '마구간에 유능한 말을 얼마나 갖출 수 있는가.',
  q2_h: '간파', q2_p: '챔피언이 될 말을 알아볼 수 있는가.',
  q3_h: '지키기', q3_p: '소멸되지 않는 말을 계속 달리게 할 수 있는가.',
  s3_closing: '사고, 단련하고, 달리게 하고, 놓아준다. 모든 판단이 당신 마구간의 이야기가 된다.',
  s4_h2: '매일 밤 20:00, 전 마 일제히 달리는 거대한 레이스.',
  s4_lead_a: '당신의 나라에서는 ', s4_lead_b: ' — 마구간의 말은 매일 밤 데일리 더비에 출전한다. 이긴 말은 가치가 오르고(100 → 110 → 121 → …), 진 말은 소멸(Burn)한다.',
  mylane_yours: '당신의 말',
  ev_champ: 'DAY7 완주 — 챔피언', ev_survive: 'DAY3 → DAY4 생존', ev_burn: 'DAY2 — 소멸',
  fc_tag: '— 내일의 예보 —', fc_title: '레이스의 마지막에 “내일의 예보”가 발표된다.',
  fc_weather_k: '날씨', fc_weather_v: '비', fc_track_k: '주로', fc_track_v: '다소 무거움', fc_course_k: '코스', fc_course_v: '잔디',
  ...
  s5_h2: '달린 말은 팔 수 있다.',
  s5_p: '매일 밤 레이스가 끝나면 마켓플레이스가 열린다. 살아남은 당신의 말은 오른 가치로 거래된다. 비싸게 팔아 이익을 실현할지, 내일도 달리게 해 더 노릴지, 새 말을 맞이할지 — 정하는 것이 마구간 주인의 일이다.',
  ...
  showcase_note_rest: '실제 출품과 가격은 로그인 후 마켓에서 볼 수 있습니다.',
  mint_label: 'MINT · 수수료 포함', see_all: '모든 출품 보기 →',
...
const ms: LandingDict = {
  ...
  step01_d: 'Mohon pembelian dan ia dipadankan automatik. Kuda yang sedang berlumba (P2P) diutamakan; jika stok kurang, mint baharu (102 USDT = harga 100 + yuran 2). Harga bergantung pada apa yang diberikan.',
  ...
  step03_d: 'Satu perlumbaan sehari. Setiap malam, semua kuda yang wujud berlari serentak. Yang terbawah dibakar (Burn) dan musnah (semua rekod umum pada lejar). Yang terselamat naik nilai dan ke hari berikutnya.',
  step04_t: 'Dagangan P2P',
  step04_d: 'Kuda terselamat membawa nilai lebih tinggi ke dagangan P2P dan merealisasi automatik. Pemilik menerima USDT serta-merta.',
  ...
  s4_lead_a: 'Di negara anda ia ialah ', s4_lead_b: ' — kuda kandang anda berlumba dalam Daily Derby setiap malam. Yang menang naik nilai (100 → 110 → 121 → …); yang kalah dibakar (Burn) — musnah.',
  ...
  s5_p: 'Apabila perlumbaan setiap malam tamat, pasaran dibuka. Kuda terselamat anda didagangkan pada nilai yang meningkat. Jual tinggi, berlari lagi esok untuk lebih, atau ambil kuda baharu — memutuskan itu tugas pemilik kandang.',
  ...
  league_p: 'Dibuka apabila pengguna aktif mencapai 10,000. Liga mingguan yang hanya kandang berkuda Juara boleh sertai. Setiap minggu, ada hadiah.',
  ...
  s7_support: 'Support Bonus',
  s7_pb: ' sebagai raikan. Kegemilangan seseorang menjadi hasil seluruh pasukan. Jadi sokong kuda rakan anda — hantar Juara seterusnya dari dalam pasukan.',
  ...
  gate_name: 'Seekor kuda tanpa nama lagi', gate_slot: '◇ Ruang kosong',
